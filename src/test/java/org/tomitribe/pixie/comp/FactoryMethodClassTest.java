...
/**
 * Tests the ability for the factory method to live in a completely different
 * class than the built class
 */
public class FactoryMethodClassTest extends Assert {
    ...
    public void test() throws Exception {
        final System system = System.builder()
                ...
                .definition(AddressFactory.class, "home")
