 ...
 *
 * We need to do our best to create components of the right type and then link them
 * together as if they were explicitly configured
 */
public class MissingDeclarationsReferenceSortingTest extends Assert {
