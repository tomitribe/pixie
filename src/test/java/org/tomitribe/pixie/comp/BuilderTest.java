...
public class BuilderTest extends Assert {
    ...
    public static class Person {
        ...
        public static class Builder {
            ...
            public Builder name(@Name final String name) {
                this.name = name;
                return this;
            }

            public Builder age(@Param("age") @Nullable final Integer age) {
                this.age = age;
                return this;
            }

            public Builder address(@Param("address") @Component final Address address) {
                this.address = address;
                return this;
            }

            public Builder link(@Event final Consumer<URI> links) {
                this.links = links;
                return this;
            }
    ...
    public static class Address {
        ...
        public static class Builder {
            ...
            public Builder street(@Param("street") final String street) {
                this.street = street;
                return this;
            }

            public Builder city(@Param("city") final String city) {
                this.city = city;
                return this;
            }

            public Builder state(@Param("state") final State state) {
                this.state = state;
                return this;
            }

            public Builder zipcode(@Param("zipcode") final int zipcode) {
                this.zipcode = zipcode;
                return this;
            }

            public Builder country(@Param("country") @Default("USA") final String country) {
                this.country = country;
                return this;
            }
