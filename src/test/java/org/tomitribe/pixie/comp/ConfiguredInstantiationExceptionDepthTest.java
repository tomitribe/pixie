 ...
 */
public class ConfiguredInstantiationExceptionDepthTest extends Assert {
    ...
    public void testGetCauseChain() {
        ...
        assertEquals(Peace.class, ((ConstructionFailedException) causes.get(0)).getComponent());
        assertEquals(Peace.class, ((NoValidConstructorException) causes.get(1)).getComponent());
    }
