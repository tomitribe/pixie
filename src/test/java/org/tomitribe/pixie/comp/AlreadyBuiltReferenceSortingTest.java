...
public class AlreadyBuiltReferenceSortingTest extends Assert {
    ...
    public void setup() throws Exception {
        ...
        first.put(SOMEDAY, "new://" + Peace.class.getName());
        first.put(EARTH, "new://" + World.class.getName());
        first.put(HELIOS, "new://" + SolarSystem.class.getName());

        final System system = new System(first);

        final Properties second = new Properties();
        second.put(LANIAKEA, "new://" + Universe.class.getName());
        second.put(MILKYWAY, "new://" + Galaxy.class.getName());
        second.put(LUNA, "new://" + Luna.class.getName());
