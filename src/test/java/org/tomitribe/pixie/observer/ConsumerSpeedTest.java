...
public class ConsumerSpeedTest extends Assert {
    ...
    private Stats time(final int observerCount) {
        ...
        final Consumer<Integer> integerConsumer = observers.consumersOf(Integer.class);
        final Consumer<String> stringConsumer = observers.consumersOf(String.class);
